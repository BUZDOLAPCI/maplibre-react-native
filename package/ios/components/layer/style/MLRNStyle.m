...
- (void)setColorReliefStyleLayerVisibility:(MLNColorReliefStyleLayer *)layer withReactStyleValue:(MLRNStyleValue *)styleValue
{
    layer.visible = [styleValue isVisible];
}

- (void)setColorReliefOpacity:(MLNColorReliefStyleLayer *)layer withReactStyleValue:(MLRNStyleValue *)styleValue
{
    layer.colorReliefOpacity = styleValue.mlnStyleValue;
}

- (void)setColorReliefOpacityTransition:(MLNColorReliefStyleLayer *)layer withReactStyleValue:(MLRNStyleValue *)styleValue
{
    layer.colorReliefOpacityTransition = [styleValue getTransition];
}

- (void)setColorReliefColor:(MLNColorReliefStyleLayer *)layer withReactStyleValue:(MLRNStyleValue *)styleValue
{
